...
###########################################################################################################
        ...
        ggg,xedges=np.histogram(d0, bins=100,range=[-1.5, 1.5], density=True)
...
############################################
        ...
        index = np.random.choice(kkk1.shape[0], 145000, replace=False)
        kkk1=kkk1[index]
        index = np.random.choice(kkk2.shape[0], 145000, replace=False)
        kkk2=kkk2[index]
        index = np.random.choice(kkk3.shape[0], 145000, replace=False)
        kkk3=kkk3[index]
        ...
        if kick==1:
              ...
              xcenters = (xedges[:-1] + xedges[1:]) / 2
              plt.plot(xcenters-xcenters[0],ggg, '-ob', markersize=2, lw=1  ,mfc='white',label=sec[kick-1]+'')
              dx=(xedges[1]-xedges[0])

              ggg,xedges=np.histogram(kkk2, bins=20,range=[0,1], density=True)
              xcenters = (xedges[:-1] + xedges[1:]) / 2
              plt.plot(xcenters-xcenters[0],ggg, '-or', markersize=2, lw=1  ,mfc='white',label=sec[kick-1]+'')
              dx=(xedges[1]-xedges[0])

              ggg,xedges=np.histogram(kkk3, bins=20,range=[0,1], density=True)
              xcenters = (xedges[:-1] + xedges[1:]) / 2
              plt.plot(xcenters-xcenters[0],ggg, '-og', markersize=2, lw=1  ,mfc='white',label=sec[kick-1]+'')
              dx=(xedges[1]-xedges[0])
              ...
              ggg,xedges=np.histogram(kkk1, bins=20,range=[0,1], density=True)
              xcenters = (xedges[:-1] + xedges[1:]) / 2
              plt.plot(xcenters-xcenters[0],ggg, '--xb', markersize=4, lw=1  ,mfc='white',label=sec[kick-1]+' :reactant')
              dx=(xedges[1]-xedges[0])

              ggg,xedges=np.histogram(kkk2, bins=20,range=[0,1], density=True)
              xcenters = (xedges[:-1] + xedges[1:]) / 2
              plt.plot(xcenters-xcenters[0],ggg, '--xr', markersize=4, lw=1  ,mfc='white',label=sec[kick-1]+' :TS')
              dx=(xedges[1]-xedges[0])

              ggg,xedges=np.histogram(kkk3, bins=20,range=[0,1], density=True)
              xcenters = (xedges[:-1] + xedges[1:]) / 2
              plt.plot(xcenters-xcenters[0],ggg, '--xg', markersize=4, lw=1  ,mfc='white',label=sec[kick-1]+' :product')
              dx=(xedges[1]-xedges[0])
