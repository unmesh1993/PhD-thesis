...
for sss in range(cut):
    ...
    avgg1[sss],avgg2[sss]=gg1,gg2
    avggg1[sss],avggg2[sss]=ggg1,ggg2
    avdens[sss]=dens


gg1,gg2=np.mean(avgg1,axis=0),np.mean(avgg2,axis=0)
ggg1,ggg2=np.mean(avggg1,axis=0),np.mean(avggg2,axis=0)
