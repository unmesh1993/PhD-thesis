...
for i in range(frames):
       ...
       for j in range(0,540,3):
           ...
           hhh1=np.zeros(180*2+hyd,float) 
           hhh2=np.zeros(180,float) 
           hhh3=np.zeros(((180*2+hyd),3),float)
           hhh4=np.zeros((180,3),float)
           index1=np.zeros(180,int)
           counter2=0
           counter3=0

           for t in range(0,540,3):
