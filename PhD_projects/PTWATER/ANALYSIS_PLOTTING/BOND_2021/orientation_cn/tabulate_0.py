...
x=d1x
y=np.degrees(np.arccos(d1y1))
ex=np.amin(d1y1)
ey=np.amax(d1y1)
gg,xedges,yedges=np.histogram2d(x, y, bins=(400,100),range=[[0.0, 20], [-10,190]], normed=True)
gg= gg.T 

plt.yticks(np.arange(-30,190,30),size=10)
plt.xticks(np.arange(0,14,2),size=10)
plt.xlim(0,7)
plt.ylim(0,180)
plt.xlabel(r'z coordinate of O (Å)',size=10)
plt.ylabel(r'$\theta$ ($^{o}$)',size=12)
my_cmap = plt.cm.jet
xcenters = (xedges[:-1] + xedges[1:]) / 2
ycenters = (yedges[:-1] + yedges[1:]) / 2
X, Y = np.meshgrid(xcenters, ycenters)

plt.contourf(X, Y, gg, [0.00001,0.00005,0.0001,0.0005,0.001,0.005,0.01,0.05],cmap=plt.cm.get_cmap('jet'),norm = LogNorm())
