...
e1x=np.amin(e1)
e1y=np.amax(e1)
gg1,xedges=np.histogram(e1, bins=1600,range=[0,80],density=True)
xcenters = (xedges[:-1] + xedges[1:]) / 2

e2=np.array(wowy,float)
e2x=np.amin(e2)
e2y=np.amax(e2)
gg2,xedges=np.histogram(e2, bins=1600,range=[0,80],density=True)

e3=np.array(wowyy,float)
e3x=np.amin(e3)
e3y=np.amax(e3)
gg3,xedges=np.histogram(e3, bins=1600,range=[0,80],density=True)


e4=np.concatenate((wowy,wowyy))
e4x=np.amin(e4)
e4y=np.amax(e4)
gg4,xedges=np.histogram(e4, bins=1600,range=[0,80],density=True)
...
dgg1,xedges=np.histogram(e1, bins=1600,range=[0,80],density=False)
dgg4,xedges=np.histogram(e4, bins=1600,range=[0,80],density=False)
