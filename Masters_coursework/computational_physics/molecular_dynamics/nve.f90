...
open(8,file='temp.dat',status='unknown',position='append')
write(8,*)'     '
close(8)
...
!rescaling velocity and setting centre of mass velocity to zero:flying icecubes
