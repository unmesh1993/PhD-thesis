...
write(*,*)"energy per spin=",energy/(tot)
write(*,*)"magnetisation per spin=",magnetisation/(tot)

!------------------------------------------------------------------------------

!metropolis algorithm
open(1,file='energy.dat' ,status='old',position='append')
open(2,file='mag.dat' ,status='old',position='append')
...
write(1,*)iteration,energy/(tot)
write(2,*)iteration,magnetisation/(tot)
